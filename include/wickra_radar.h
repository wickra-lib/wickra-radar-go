/* wickra-radar C ABI — generated by cbindgen; do not edit by hand. */

#ifndef WICKRA_RADAR_H
#define WICKRA_RADAR_H
...
#define WICKRA_RADAR_ERR_NULL -1

// `cmd_json` was not valid UTF-8.
#define WICKRA_RADAR_ERR_UTF8 -2

// A panic was caught at the FFI boundary.
#define WICKRA_RADAR_ERR_PANIC -3
...
typedef struct WickraRadar WickraRadar;
...
int32_t wickra_radar_command(WickraRadar *handle, const char *cmd_json, char *out, uintptr_t cap);
